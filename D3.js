...
for (let index = 0; index < starWarsCharacters.length; index++) {
  const colors = starWarsCharacters[index];
  switch (colors.eye_color) {
    case "blue":
      eyeColor.blue.push(colors);
      break;
    case "yellow":
      eyeColor.yellow.push(colors);
      break;
    case "brown":
      eyeColor.brown.push(colors);
      break;
    case "red":
      eyeColor.red.push(colors);
      break;
    case "blue-gray":
      eyeColor["blue-gray"].push(colors);
      break;
  }
}
...
console.log("tutti i nomi:", charactersNames);
...
console.log("tutti i nomi maschili:", charactersNames);
